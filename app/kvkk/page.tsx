...
export default function KvkkPage() {
  return (
    <>
      <BreadcrumbSchema items={[{ name: 'Ana Sayfa', path: '/' }, { name: 'KVKK Aydınlatma Metni', path: '/kvkk' }]} />
      <LegalPage
      ...
      sections={[
        ...
        { title: 'Toplama yöntemi ve aktarım', body: <p>Formu doldurduğunuzda bilgiler tarayıcınızda bir WhatsApp mesajı taslağına dönüşür; mesajı göndermek sizin onayınıza bağlıdır. Web Sitesi Sipariş formundaki bilgiler, sayfa yenilense de kaybolmasın diye yalnızca cihazınızın yerel depolamasında taslak olarak saklanır; sunucumuza gönderilmez, yedi gün sonra silinir ve formdaki “Taslağı sil” bağlantısıyla hemen silebilirsiniz. Gönderdiğiniz mesaj WhatsApp altyapısı üzerinden bize ulaşır ve WhatsApp&apos;ın kendi gizlilik koşullarına tabidir. Verileriniz ticari amaçla üçüncü kişilere satılmaz veya devredilmez; yalnızca yasal yükümlülükler gereği yetkili kurumlarla paylaşılabilir.</p> },
