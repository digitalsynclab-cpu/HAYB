...
export function TemplateSite({ t }: { t: TemplateDef }) {
  ...
  // Huni: şablon demosu görüntülendi (yalnızca şablon kimliği gönderilir, kişisel veri yok).
  useEffect(() => {
  ...
  return (
    <div className="tp" style={vars}>
      <div className="flex items-center justify-between gap-3 bg-black px-4 py-2 text-xs font-semibold text-white">
        ...
        <p className="hidden min-w-0 truncate text-center text-[#a6ff41] md:block">{t.code} · HAYB örnek şablonu · Marka, içerik ve formlar kurgusaldır.</p>
      ...
      <div className="bg-black px-4 py-10 text-center text-white">
        ...
        <div className="mt-5 flex flex-wrap items-center justify-center gap-3">
          ...
          <a href={whatsappUrl(`Merhaba, HAYB sitesindeki ${templateUrl(t.slug)} örnek şablonunu beğendim. Kendi işletmem için benzer bir site istiyorum.`)} target="_blank" rel="noopener noreferrer" className="inline-flex min-h-12 items-center gap-2 rounded-full border border-white/25 px-5 text-sm font-semibold">
