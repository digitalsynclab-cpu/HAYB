...
export const services: ServiceDetail[] = [
  ...
  },
  {
    ...
    icon: 'eticaret',
    filter: 'Web',
    summary: 'Ürünlerinizi online satın: iyzico / PayTR ile ödeme, stok ve sipariş yönetimi.',
    metaTitle: 'E-Ticaret Sitesi Kurulumu: iyzico ve PayTR Entegrasyonlu',
    metaDescription:
      'Online mağazanızı kuruyoruz: iyzico veya PayTR ile kredi kartı ve taksitli ödeme, ürün-stok-sipariş paneli, kampanya ve SEO araçları. E-ticaret paketleri 39.990 ₺’den başlar.',
    heroTitle: 'Online mağazanız',
    heroAccent: 'satışa hazır.',
    heroText:
      'Ürünlerinizi yükleyin, ödemeyi iyzico veya PayTR ile alın; sipariş ve stok süreçlerini tek panelden yönetin. Tasarımdan yayına kadar kurulumu biz yaparız.',
    showcase: 'commerce',
    benefits: [
    ...
    steps: [
      ...
      { title: 'Ödeme', text: 'iyzico / PayTR sanal POS entegrasyonunu bağlarız.' },
