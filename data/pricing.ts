...
export const webPricingRows: WebPricingRow[] = [
  ...
  { label: 'Alan Adı (Ücretsiz)',         starter: '.com.tr / .net.tr / .org.tr (1 Yıl)', business: '.com.tr / .net.tr / .org.tr (2 Yıl)', professional: '.com / .net / .org (2 Yıl)',         premium: '.com / .net / .org (2 Yıl)'    },
